    ...
    <Card className="border-amber-500/50 bg-amber-50/30 dark:bg-amber-950/20" data-testid="card-structural-guidance">
      ...
      <CardContent className="space-y-4">
        <div className="text-sm text-muted-foreground">
          ...
          {pending.wbaExternalRan ? " + un audit adicional del Auditor de World Bible" : ""}, el mejor
          intento se queda en <strong>{pending.bestScore}/10</strong>, por debajo del mínimo publicable
          de <strong>{pending.threshold}/10</strong>. El sistema no va a escribir la novela sobre una
          escaleta defectuosa. Revisa los problemas residuales y dale al Arquitecto instrucciones concretas
          (por ejemplo: "mueve el reveal del traidor al capítulo 18", "elimina el subplot de Marta", "el
          antagonista debe aparecer ya en el capítulo 3").
        </div>
