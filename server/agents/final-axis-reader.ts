...
export class FinalAxisReaderAgent extends BaseAgent {
  constructor() {
    super({
      ...
      useThinking: true,
      thinkingBudget: 8192,
      // [Fix155] CAUSA RAIZ del `null` de Fix154: esta puerta lee la NOVELA
      // COMPLETA, la entrada mas grande del sistema. Con thinking en esfuerzo
      // "max", el razonamiento consumia casi todo el presupuesto COMBINADO de
